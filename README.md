...
Although this is not a feature for feature port, ThisIsTheWayshrine aims to provide its own take on the BeamMeUp functionality so that players on XBox and Playstation can focus less on the chores of grinding out location discovery or similar tasks, and focus more on the fun that brings them to Elder Scrolls Online in the first place.
